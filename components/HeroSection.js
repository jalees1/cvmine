    ...
    <div className="bg-blue-50 p-4 md:p-1">
      <div className="max-w-4xl mx-auto space-y-8 p-4">
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
          ...
          {/* Select Dropdown for All/Jobs/Companies */}
          <Select className="w-full md:w-[100px]">
          <SelectTrigger className="bg-transparent md:bg-white"> {/* Background for trigger */}
          <SelectValue placeholder="All" />
          </SelectTrigger>
          <SelectContent className="bg-white"> {/* Background for dropdown content */}
          ...
          <div className="relative flex w-full md:flex-1 md:w-auto"> {/* Full width on mobile */}
          <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400">
          <Search className="w-4 h-4" /> {/* Added the Lucide Search icon */}
          </span>
          <Input
          className="pl-10 w-full" // Make the input full width on mobile
          ...
          <Select className="w-full md:w-[150px]">
          <SelectTrigger className="bg-white"> {/* Set background for trigger */}
          <SelectValue placeholder="Location" />
          </SelectTrigger>
          <SelectContent className="bg-white"> {/* Set background for dropdown */}
